		...
		if ($bRightPage && CModule::IncludeModule('iblock')) {
			...
			if (CASDiblockVersion::isIblockNewGridv18()) {
				...
				if ($multiControl) {
					...
					$enableMultiSelect = (string)\Bitrix\Main\Config\Option::get('asd.iblock', 'enable_section_multiselect') === 'Y';
										...
										array(
											...
											'ONCHANGE' => array(
												array(
													...
													'DATA' => array(
														array(
															'JS' => "ASDShowSectionWindow('asd_sect_iblock_id_copy', 'asd_sect_id_copy', '".LANGUAGE_ID."', ".($enableMultiSelect ? 'true' : 'false').");"
														)
													)
												)
											)
										...
										array(
											...
											'ONCHANGE' => array(
												array(
													...
													'DATA' => array(
														array(
															'JS' => "ASDShowSectionWindow('asd_sect_iblock_id_move', 'asd_sect_id_move', '".LANGUAGE_ID."', ".($enableMultiSelect ? 'true' : 'false').");"
														)
													)
												)
											)
