...
$APPLICATION->SetPageProperty("title", "Купить фасадную кровлю, забор, водосток и мансардные окна по доступным ценам");
$APPLICATION->SetPageProperty("description", "Кровля, фасад, забор, водосток и комплектующие приобрести в магазине FineRoof");
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_PROPERTY_CODE" => array("SUB_TITLE","PRICE","BRAND",""),
