...
$APPLICATION->SetPageProperty("description", "Данная политика конфиденциальности ИП НАУРЗАЛИЕВ Е.Р. ОГРНИП 317344300065902, относится к сайту под доменным именем fineroof.ru");
$APPLICATION->SetTitle("Политика конфиденциальности");
?><p>Данная политика конфиденциальности ИП НАУРЗАЛИЕВ Е.Р. ОГРНИП 317344300065902, относится к сайту под доменным именем <a href="/">fineroof.ru</a> Эта страница содержит сведения о том, какую информацию мы (администрация сайта) или третьи лица могут получать, когда вы пользуетесь нашим сайтом.
</p>
...
<p>Сбор, хранение и защита полученной от сторонней организации информации осуществляется в соответствии с настоящей политикой конфиденциальности.
</p>
...
<p>Если у вас есть какие-либо вопросы о политике конфиденциальности, использованию сайта или иным вопросам, связанным с сайтом, свяжитесь с нами:
 <a href="tel:+79610657599">+7 961 065 75 99</a>, <a href="tel:+78442297783">+7 (8442) 29 77 83</a> или по электронной почте <a href="mailto:help@fineroof.ru">help@fineroof.ru</a></p>
