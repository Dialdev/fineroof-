            ...
            <div class="inner-page__wrap distributing-page">
                ...
                <div class="distributing-page__wrap">
                    <? foreach ($arResult['SECTIONS'] as $key => $arSect) {
                        ...
                        $this->AddDeleteAction($arSect['ID'], $arSect['DELETE_LINK'], $strSectionDelete,
                            $arSectionDeleteParams); ?>
                        <?= $key == 0 || $key == 2 || $key == 4 ? '<div class="distributing-page__column">' : '' ?>
                        <div class="distributing-page__item<?= $key == 0 || $key == 3 || $key == 4 ? ' distributing-page__item_big' : '' ?>"
                             id="<? echo $this->GetEditAreaId($arSect['ID']); ?>">
                ...
                <div class="props-table__wrap">
                    <div class="props-table__tabs">
                        <? if ($arResult['SECTION']['UF_PRICE_LIST'] || $arResult['SECTION']['UF_SALE_FILE']): ?>
                            <div class="props-table__tab jsTab classic-button classic-button_white isActive">Узнать
                                цены
                            </div>
                        <? endif; ?>
                    ...
                    <div class="props-table__body isActive">
                        <div class="props-table__list price-tab isActive">
                            ...
                            <div class="price-tab__wrap">
                                <a href="<?= CFile::GetPath($arResult['SECTION']['UF_PRICE_LIST']); ?>" target="_blank"
                                   class="price-tab__item">
                                ...
                                <a href="<?= CFile::GetPath($arResult['SECTION']['UF_SALE_FILE']); ?>" target="_blank"
                                   class="price-tab__item">
                        ...
                        <div class="props-table__list guarantee-tab">
                            ...
                            <div class="props-table__links">
                                <? foreach ($arResult['SECTION']['UF_FILES_GUARANT'] as $arGuarant): ?>
                                    <a href="<?= CFile::GetPath($arGuarant); ?>" target="_blank"
                                       class="props-table__link">
                                <span class='props-table__icon'>
                                    ...
                                    <span>гарантийный талон <span
                                                class="download-value"><?= $arResult['SECTION']['NAME'] ?></span> </span>
                                </span>
                                    </a>
                                <? endforeach; ?>
                            </div>
                                ...
                                <? foreach ($arResult['SECTION']['UF_SERTIFICATES'] as $arSert): ?>
                                    <div class="props-table__sertificate">
                                        <div class="props-table__image">
                                            <a href="<?= CFile::GetPath($arSert); ?>" class="jsBoxSertificate"
                                               data-title="Сертификат" data-description="Описание" data-type="image">
                                                <img src="<?= SITE_TEMPLATE_PATH ?>/template/img/sertif.jpg"
                                                     alt="Сертификат">
                                            </a>
                                        </div>
                ...
                <div class="catalog-list__detail catalog-section">
                                            ...
                                            <form action="<?= $APPLICATION->GetCurPage(false) ?>" id="brandlist">
                                                <div class="catalog-section__select brand-select">
                                                    <div class="brand-select__left">
                                                        ...
                                                        <?
                                                        foreach ($arResult['UF_BRAND'] as $key => $arItem): ?>
                                                            <div class="brand-select__position">
                                                                <?= $arItem['UF_NAME'] ?>
                    ...
                    <div class="catalog-section__list">
                        <div class="container-inner container-inner_medium">
                            <div class="catalog-section__wrapper catalog-section__wrapper_items ajax_refresh">
                                <!--RestartBuffer-->
                                <? foreach ($arResult['SECTIONS'] as $arItem):
                                    $this->AddEditAction($arItem['ID'], $arItem['EDIT_LINK'], $strSectionEdit);
                                    $this->AddDeleteAction($arItem['ID'], $arItem['DELETE_LINK'], $strSectionDelete,
                                        $arSectionDeleteParams); ?>
                                    <div class="catalog-section__item card-item"
                                        ...
                                        <? if ($arItem['UF_PRICE']): ?>
                                            ...
                                            ><?= is_numeric($arItem['UF_PRICE'])
                                                    ? $arItem['UF_PRICE'] . ' ₽ – ШТ.'
                                                    : $arItem['UF_PRICE'] ?>
                                            </div>
                                        <? else: ?>
                                            <div class="card-item__button classic-button classic-button_green jsOpenPopup" data-target='.jsCallbackForm'
                                            ><?= is_numeric($arItem['ELEMENT_PRICE'])
