...
$res = CIBlockSection::GetList(
    ...
    [
        'IBLOCK_ID' => 1,
        'ID'        => $arResult['IBLOCK_SECTION_ID'] ? $arResult['IBLOCK_SECTION_ID'] : $arResult['ID']
    ],
    true,
    ['*']
)->Fetch();
...
?><? if($arResult['ITEMS'] && $res['ELEMENT_CNT'] > 0){ ?>
                        ...
                        <div class="container-inner container-inner_medium">
                            <div class="catalog-section__wrapper catalog-section__wrapper_items ajax_pagination">
                                ...
                                <? foreach ($arResult['ITEMS'] as $arItem) {
                                    ...
                                    <div class="catalog-section__item card-item" id="<? echo $this->GetEditAreaId($arItem['ID']); ?>" data-brand="<?= $arItem['PROPERTIES']['BRAND']['VALUE'] ?>">
...
<!--<? echo $ar_res['NAME']; ?>-->    <?= $arItem['NAME'] ?>
                                ...
                                $APPLICATION->IncludeComponent(
                                    ...
                                    Array(
                                        ...
                                        "CACHE_TYPE"          => "N",
                                        "COUNT_ELEMENTS"      => "N",
                                        "FILTER_NAME"         => "UF_SECTION_ELEMENT",
                                        "FILTER_VALUE"        => "1",
                                        "IBLOCK_ID"           => "1",
                                        "IBLOCK_TYPE"         => "catalog",
