...
$res = CIBlockElement::GetList([],['CODE' => $arResult['VARIABLES']['ELEMENT_CODE']], false, false, ['*'])->Fetch();
$sect = CIBlockSection::GetNavChain($res['IBLOCK_ID'],$res['IBLOCK_SECTION_ID'])->Fetch();
?>

<div class="inner-title">
    <div class="container">
        <div class="inner-title__wrap">
            <div class="inner-title__services custom-title custom-title_inner custom-title_full-house __element-detail">
                <? $titleDom = $sect['NAME'] ?>
                <? $titleDomLast = substr($titleDom, -1, 1); ?>
                <span class="title"><?= substr($titleDom, 0, -1); ?><span>
                        <?= $titleDomLast ?>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"ID_CHAT" => $APPLICATION->GetCurPage(),
		"AUTH" => "Y",
		"AUTH_URL" => "",
		"ENTRY_URL" => "",
		"MODERATION" => "Y",
